...
| M4 GPT + tokenizer | GPT and minBPE plus complete course distribution | Reduced GPT preset completes; original settings launch and checkpoint; tokenizer variants and files work | Planned |
